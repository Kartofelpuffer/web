        ...
        <section className="py-12">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <ul className="grid md:grid-cols-2 gap-4 text-slate-700">
              ...
              <li className="p-4 bg-white rounded-lg shadow-sm flex gap-3"><CheckCircle2 className="w-5 h-5 text-blue-600 mt-0.5" />Fast support by text at (214) 795-3984.</li>
            </ul>
          </div>
        </section>
        ...
        <section className="py-12 bg-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              <a href={SMS_QUOTE_HREF} className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-semibold">Text (214) 795-3984</a>
