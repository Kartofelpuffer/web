...
export default function Layout({ children, currentPageName }) {
  ...
  useEffect(() => {
    ...
    const ogTags = [
      ...
      { property: 'og:description', content: 'Mobile detailing in McKinney, Frisco, Allen & Plano. Interior and exterior packages with limited basic maintenance like oil changes.' },
      ...
      { name: 'twitter:description', content: 'Detailing-first mobile service in McKinney, Frisco, Allen & Plano. Interior and exterior packages plus limited basic maintenance.' },
    ...
    upsertJsonLd('local-business-schema', {
      ...
      'description': 'Mobile detailing services in McKinney, Frisco, Allen, and Plano, TX. Interior and exterior packages plus limited basic maintenance and fleet detailing.',
