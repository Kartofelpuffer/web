...
export default function Layout({ children, currentPageName }) {
  ...
  const getActiveTab = (pathname) => {
    ...
    if ((pathname.startsWith('/Blog') && !pathname.startsWith('/BlogPost')) || pathname.startsWith('/blog/')) return 'Blog';
  ...
  useEffect(() => {
    ...
    const normalizedPath = currentUrl.pathname === '/Home' ? '/' : currentUrl.pathname;
    const canonicalUrl = `${currentUrl.origin}${normalizedPath}`;
